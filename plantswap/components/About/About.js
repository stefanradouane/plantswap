...
const About = () => {
  ...
  return (
    <main className={styles.about}>
      <ul
        className={`${styles.about__indicator} ${getIndicatorClassName(
          currentSection
        )}`}>
        <section
          className={styles.about__SectionBtn}
      ...
      <AboutSection
        ...
        altText={"ons netwerk"}
        text={
          "Heb jij een of meerdere plantenstekjes over en zou je die graag willen ruilen voor een nieuw plantje? Ruil je plantje met PlantSwap!"
        }
        title={"Over ons"}
        buttonText={"Swap!"}
      ...
      <AboutSection
        ...
        altText={"swapkast"}
        text={
          "Binnen Plantswap kun je kiezen uit de opties ruilen of doneren. Met de optie ‘ruilen’ kies je uit onze beschikbare stekjes uit de stekjeskast. Vul het formulier in en kom je stekje bij ons ruilen!"
        }
      ...
      <AboutSection
        ...
        altText={"stekje"}
        text={
          "Heb jij (net als wij) teveel planten in huis? Wij zijn super blij als je stekjes komt doneren. Je kunt ze aanmelden via de app en daarna neerzetten in de PlantSwap kast in de bieb."
        }
      ...
      <AboutSection
        ...
        altText={"test"}
        text={
          "De eerste workshop ‘Planten stekken en verzorgen’ zal plaatsvinden in juni 2023 in de OBA Linnaeusstraat, meld je hier aan voor meer informatie en om op de hoogte te blijven."
        }
        title={"Workshops"}
